...
public class BoxRenderer implements GLSurfaceView.Renderer{
    ...
    //LinkedList<double[]> boxCoords;
    //LinkedList<Double> boxCred;
    //LinkedList<Integer> boxTag;
    ...
    public void renewData(ArrayList<double[]> boxCoords, ArrayList<Double> boxCred, ArrayList<Integer> boxTag){
        for(int i = 0;i < boxCoords.size();i++){
            detectionBoxes.add(new DetectionBox(boxCoords.get(i),boxCred.get(i),boxTag.get(i)));
        }
    }
}
